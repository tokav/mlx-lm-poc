...
use crate::generate::kv_cache::KeyValueCache;
...
impl SelfAttn {
    pub fn new(args: &ModelArgs) -> Result<Self, Exception> {
        ...
        // Build RoPE with Llama 3.2 configuration
...
impl Model {
    pub fn new(args: &ModelArgs) -> Result<Self, ModelError> {
        ...
        // Llama has tie_word_embeddings = true
